...
from .views import EnergyUsageDataDevice24, EnergyUsageDataLocation24,HistoryEnergyUsageAPIView, DeviceEnergyUsageAPIView, LocationEnergyComparisonAPIView
urlpatterns = [
